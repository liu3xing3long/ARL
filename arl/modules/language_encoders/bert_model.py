...
class BertCrossLayerWithKnowledge(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.chunk_size_feed_forward = config.chunk_size_feed_forward
        self.seq_len_dim = 1
        ...
        self.knowledge_attention = BertAttention(self.knowledge_config)
        self.knowledge_crossattention = BertAttention(self.knowledge_config)
        self.knowledge_intermediate = BertIntermediate(self.knowledge_config)
        self.knowledge_output = BertOutput(self.knowledge_config)
